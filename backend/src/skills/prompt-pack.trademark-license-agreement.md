...
intent: ["drafting", "trademark-license-agreement"]
...
> Draft a trademark license agreement for [Licensor] to grant [Licensee] rights to use [trademarks] for [products/services] in [territory]. Include quality control provisions, usage guidelines, royalties, term, audit rights, and protection obligations.
