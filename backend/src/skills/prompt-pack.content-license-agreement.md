...
intent: ["drafting", "content-license-agreement"]
...
> Draft a content license agreement for [Licensor] to grant [Licensee] rights to use [describe content: images/videos/articles/music] for [describe use]. Include license scope, usage restrictions, attribution requirements, exclusivity, fees, and takedown obligations.
