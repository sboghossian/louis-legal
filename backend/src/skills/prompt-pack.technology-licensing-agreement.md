...
intent: ["drafting", "technology-licensing-agreement"]
...
> Draft a technology licensing agreement granting [licensee] a [exclusive/non-exclusive] license to use [technology/software/patent] in [territory]. Include scope of license, sublicensing rights, royalty structure, IP ownership, warranties, indemnification, and audit rights.
