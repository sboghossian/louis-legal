---
id: prompt-pack.ip-assignment-agreement
name: "IP Assignment Agreement"
category: prompt-pack
intent: ["drafting", "ip-assignment-agreement"]
...
> Draft an IP assignment agreement for [Assignor] to transfer all rights in [describe IP: patents/trademarks/copyrights/trade secrets] to [Assignee]. Include consideration, representations of ownership, further assurances, and recordation obligations.
