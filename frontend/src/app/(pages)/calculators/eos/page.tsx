        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-card border border-border rounded-lg p-6 space-y-4">
                    <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground mb-2">Inputs</h2>
                    ...
                    <div>
                        <Label htmlFor="salary" className="text-xs">
                            ...
                            <span className="text-muted-foreground ml-2">basic only — exclude housing/allowances for UAE/QA/OM</span>
                        </Label>
                        <Input
                            id="salary"
                            type="number"
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-3 gap-2 mt-1">
                            <div>
                                ...
                                <div className="text-[10px] text-muted-foreground mt-0.5 ml-1">years</div>
                            </div>
                            <div>
                                <Input type="number" value={months} onChange={e => setMonths(e.target.value)} placeholder="months" />
                                <div className="text-[10px] text-muted-foreground mt-0.5 ml-1">months</div>
                            </div>
                            <div>
                                <Input type="number" value={days} onChange={e => setDays(e.target.value)} placeholder="days" />
                                <div className="text-[10px] text-muted-foreground mt-0.5 ml-1">days</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-2 pt-2">
                        <label className="flex items-center gap-2 text-sm">
                            ...
                            <span className="text-xs text-muted-foreground">(affects KSA)</span>
                        </label>
                        <label className="flex items-center gap-2 text-sm">
                            <input
                                type="checkbox"
                            ...
                            <span className="text-xs text-muted-foreground">(UAE Art. 44 / KSA Art. 80)</span>
                        </label>
                    </div>
                ...
                <div className="bg-card border border-border rounded-lg p-6">
                    <h2 className="text-sm font-semibold uppercase tracking-wide text-muted-foreground mb-2">Result</h2>
                    ...
                    {result && (
                        <div className="space-y-4">
                            <div className="bg-gradient-to-br from-blue-50 to-emerald-50 border border-emerald-200 rounded-lg p-5">
                                <div className="text-xs text-muted-foreground uppercase tracking-wide">Estimated Gratuity</div>
                            ...
                            <div>
                                <div className="text-xs font-semibold uppercase tracking-wide text-muted-foreground mb-2">Breakdown</div>
