...
export function NewWorkflowModal({ open, onClose, onCreated, editWorkflow, onUpdated }: Props) {
    ...
    return (
        <div className="fixed inset-0 z-101 flex items-center justify-center bg-black/20 backdrop-blur-xs">
            <div className="w-full max-w-2xl rounded-2xl bg-card shadow-2xl overflow-hidden flex flex-col" style={{ height: 600 }}>
                {/* Header */}
                        ...
                        <div className="mt-5">
                            ...
                            {isOthers && (
                                <input
                                    ...
                                    className="mt-3 w-full rounded-md border border-border px-3 py-1.5 text-sm text-foreground/80 placeholder-gray-400 focus:border-border focus:outline-none"
                                />
                            )}
                        </div>
