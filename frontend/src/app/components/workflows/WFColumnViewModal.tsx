            ...
            <div className="w-full max-w-2xl rounded-2xl bg-card shadow-2xl flex flex-col h-[600px]">
                ...
                <div className="px-6 pt-3 pb-5 flex flex-col gap-4 overflow-y-auto flex-1">
                    ...
                    <div>
                        ...
                        <div className="text-base text-foreground/80 leading-relaxed font-serif prose prose-base max-w-none">
                ...
                <div className="border-t border-border px-6 py-4 flex justify-end shrink-0">
                    <button onClick={onClose} className="rounded-lg bg-foreground px-5 py-2 text-sm font-medium text-white hover:bg-foreground">
                        Close
                    </button>
                </div>
            </div>
