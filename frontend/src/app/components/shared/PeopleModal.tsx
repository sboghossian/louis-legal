                    ...
                    <div className="px-4 pt-1 pb-2">
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                disabled={!canAdd}
                                title="Add member"
                                className="inline-flex items-center justify-center rounded-lg border border-foreground bg-foreground p-2 text-white hover:bg-foreground disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {busy === "add" ? (
                        ...
                        <ul className="divide-y divide-border [&>li:nth-child(2)]:border-t-0">
                            {roster.map((entry) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-foreground text-white">
                                        ...
                                        {entry.role === "member" &&
                                            onSharedWithChange && (
                                                <button
                                                    ...
                                                    disabled={busy !== null}
                                                    title="Remove access"
                                                    className="self-center inline-flex items-center gap-1 rounded px-2 py-1 text-xs text-muted-foreground hover:bg-red-50 hover:text-red-600 disabled:opacity-50"
                                                >
                                                    {isRemoving && (
