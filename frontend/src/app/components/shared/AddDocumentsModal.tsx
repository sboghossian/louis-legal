...
interface Props {
    open: boolean;
    onClose: () => void;
    onSelect: (documents: LouisDocument[], projectId?: string) => void;
    breadcrumb: string[];
...
export function AddDocumentsModal({
    ...
    const [extraUploadedDocs, setExtraUploadedDocs] = useState<LouisDocument[]>([]);
    ...
    async function handleDelete(ids: string[]) {
        ...
        const docsById = new Map<string, LouisDocument>();
        for (const d of [
            ...standaloneDocuments,
            ...extraUploadedDocs,
            ...projects.flatMap((p) => p.documents ?? []),
                ...
                <div className="border-t border-border px-4 py-3 flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className="rounded-lg bg-foreground px-4 py-1.5 text-sm font-medium text-white hover:bg-foreground disabled:opacity-40"
                        >
