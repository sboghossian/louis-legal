...
function SectionLabel({ children }: { children: React.ReactNode }) {
    return <p className="text-xs font-medium text-foreground/80">{children}</p>;
}
    ...
    return (
        <div className="flex items-center gap-2">
            <button
                ...
                className="inline-flex items-center gap-1 rounded-lg border border-foreground bg-foreground px-2 py-1.5 text-xs font-medium text-white hover:bg-foreground disabled:opacity-50 disabled:cursor-not-allowed"
            >
            ...
            <button
                ...
                disabled={inFlight || resolved}
                className="inline-flex items-center gap-1 rounded-lg border border-border bg-card px-2 py-1.5 text-xs font-medium text-foreground/80 hover:bg-muted disabled:opacity-50 disabled:cursor-not-allowed"
            >
...
function DownloadButton({
    ...
    return (
        <button
            onClick={handleClick}
            disabled={spinning}
            className="inline-flex items-center gap-1 rounded-lg border border-border px-2 py-1.5 text-xs font-medium text-muted-foreground hover:bg-muted hover:text-foreground disabled:opacity-50 disabled:cursor-not-allowed"
        >
            {spinning ? (
