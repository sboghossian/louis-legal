...
export function AssistantSidePanel({
    ...
    return (
        <div
            ref={panelRef}
            className="flex h-full shrink-0 flex-col bg-card relative border-l border-border shadow-[-4px_0_12px_rgba(0,0,0,0.02)]"
        ...
        >
            ...
            <div className="flex items-end gap-1 pr-2 pt-2 bg-muted">
                        ...
                        return (
                            <div
                                ...
                                className={`group relative flex items-center gap-1.5 pl-3 pr-1.5 h-8 min-w-0 max-w-[220px] rounded-t-lg cursor-pointer select-none transition-colors ${
                                    isActive
                                        ? "bg-card text-foreground before:content-[''] before:absolute before:bottom-0 before:-left-2 before:w-2 before:h-2 before:bg-[radial-gradient(circle_at_top_left,transparent_8px,white_9px)] after:content-[''] after:absolute after:bottom-0 after:-right-2 after:w-2 after:h-2 after:bg-[radial-gradient(circle_at_top_right,transparent_8px,white_9px)]"
                            ...
                            >
                                ...
                                <button
                                    ...
                                    className="shrink-0 rounded-full p-0.5 text-muted-foreground hover:bg-muted hover:text-foreground/80"
                                >
                                    <X className="h-3 w-3" />
                                </button>
                            </div>
                ...
                <button
                    onClick={onCloseAll}
                    className="shrink-0 mb-1 ml-1 rounded-lg p-1.5 text-muted-foreground hover:bg-muted hover:text-foreground/80"
                    title="Close panel"
                >
                    <X className="h-4 w-4" />
                </button>
