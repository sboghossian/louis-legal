...
export function EditCard({
    ...
    return (
        <div className="border border-border rounded-lg p-3 bg-muted">
            ...
            <div className="text-sm leading-relaxed font-serif bg-card border border-border rounded-md px-2 py-2">
            ...
            <div className="flex gap-2 mt-3">
                <button
                    ...
                    className="px-2 py-1 text-xs rounded border border-foreground bg-foreground text-white hover:bg-foreground disabled:opacity-50"
                >
                ...
                <button
                    ...
                    disabled={inFlight || resolved}
                    className="px-2 py-1 text-xs rounded border border-border bg-card text-foreground/80 hover:bg-muted disabled:opacity-50"
                >
                ...
                {onViewClick && (
                    <button
                        ...
                        className="ml-auto px-2 py-1 text-xs rounded border border-border bg-card text-foreground/80 hover:bg-muted disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-card"
                    >
                        View
                    </button>
                )}
