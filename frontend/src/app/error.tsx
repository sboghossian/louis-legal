        ...
        <div className="min-h-screen bg-card flex items-center justify-center px-4">
            <div className="text-center max-w-md">
                ...
                <div className="flex items-center justify-center gap-3">
                    ...
                    <Link
                        href="/"
                        className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-medium text-foreground/80 border border-border hover:bg-muted transition-colors"
                    >
                        Home
                    </Link>
                </div>
